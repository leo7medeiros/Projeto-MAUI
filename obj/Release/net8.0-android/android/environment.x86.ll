...
@dso_cache = dso_local local_unnamed_addr global [676 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 337286749, ; hash 0x141a965d, from name: aot-SkiaSharp.Extended.Svg
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 490820849, ; hash 0x1d4154f1, from name: aot-SkiaSharp.Extended.Svg.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.31_name, ; name: libaot-SkiaSharp.Extended.Svg.dll.so
		ptr null; void* handle (0x0)
	}, ; 66
	...
	%struct.DSOCacheEntry {
		i64 590712906, ; hash 0x2335904a, from name: libaot-Maui.DataGrid
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 904944278, ; hash 0x35f05a96, from name: aot-MauiAppProject.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1039431970, ; hash 0x3df47922, from name: Maui.DataGrid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Maui.DataGrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 154
	%struct.DSOCacheEntry {
		i64 1048505158, ; hash 0x3e7eeb46, from name: Maui.DataGrid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Maui.DataGrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 155
	...
	%struct.DSOCacheEntry {
		i64 1221161837, ; hash 0x48c9736d, from name: MauiAppProject
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauiAppProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 177
	...
	%struct.DSOCacheEntry {
		i64 1222766210, ; hash 0x48e1ee82, from name: SkiaSharp.Extended.Svg.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.31_name, ; name: libaot-SkiaSharp.Extended.Svg.dll.so
		ptr null; void* handle (0x0)
	}, ; 179
	...
	%struct.DSOCacheEntry {
		i64 1463965377, ; hash 0x574256c1, from name: MauiAppProject.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauiAppProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 223
	...
	%struct.DSOCacheEntry {
		i64 1898574260, ; hash 0x7129f1b4, from name: aot-Maui.DataGrid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Maui.DataGrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 290
	...
	%struct.DSOCacheEntry {
		i64 1963377102, ; hash 0x7506c1ce, from name: libaot-MauiAppProject.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauiAppProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 305
	...
	%struct.DSOCacheEntry {
		i64 2219099807, ; hash 0x8444c69f, from name: libaot-Maui.DataGrid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Maui.DataGrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 352
	...
	%struct.DSOCacheEntry {
		i64 2467517983, ; hash 0x9313561f, from name: aot-Maui.DataGrid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Maui.DataGrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 395
	...
	%struct.DSOCacheEntry {
		i64 2788491197, ; hash 0xa634ffbd, from name: libaot-SkiaSharp.Extended.Svg
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.31_name, ; name: libaot-SkiaSharp.Extended.Svg.dll.so
		ptr null; void* handle (0x0)
	}, ; 447
	...
	%struct.DSOCacheEntry {
		i64 2854551965, ; hash 0xaa25019d, from name: SkiaSharp.Extended.Svg
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.31_name, ; name: libaot-SkiaSharp.Extended.Svg.dll.so
		ptr null; void* handle (0x0)
	}, ; 459
	...
	%struct.DSOCacheEntry {
		i64 3225902022, ; hash 0xc0475bc6, from name: libaot-SkiaSharp.Extended.Svg.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.31_name, ; name: libaot-SkiaSharp.Extended.Svg.dll.so
		ptr null; void* handle (0x0)
	}, ; 525
	...
	%struct.DSOCacheEntry {
		i64 3617386607, ; hash 0xd79cf06f, from name: libaot-MauiAppProject
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauiAppProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 575
	...
	%struct.DSOCacheEntry {
		i64 3741064681, ; hash 0xdefc1de9, from name: aot-MauiAppProject
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-MauiAppProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 595
